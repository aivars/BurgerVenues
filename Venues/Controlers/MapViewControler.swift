...
extension HomeViewController: CLLocationManagerDelegate {
    ...
    func searchForVenue() {
        ...
        let url = "https://api.foursquare.com/v2/search/recommendations?ll=\(currentLocation.latitude),\(currentLocation.longitude)&v=20182411&categoryId=4bf58dd8d48988d16c941735&limit=250&client_id=\(Constants.Foursquare.clientId)&client_secret=\(Constants.Foursquare.clientSecret)"
...
//            let locationPoint = try? JSONDecoder().decode(VenueSpot.self, from: data)
    ...
    func addVenuesOnMap(){
        ...
        for venue in searchResults {
            ...
            if distance(from: Constants.Locations.tartuBusStationloc, to: currentVenueLocation) > 1000 {
